 ...
 */
final class Version20181230031625 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduler CHANGE description description MEDIUMTEXT NOT NULL, CHANGE status status TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduler CHANGE status status TINYINT(1) NOT NULL, CHANGE description description MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
