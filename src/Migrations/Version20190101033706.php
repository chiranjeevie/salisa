 ...
 */
final class Version20190101033706 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE revel_to_netsuite_history ADD processed_records_count BIGINT NOT NULL, CHANGE error error MEDIUMTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE revel_to_netsuite_history DROP processed_records_count, CHANGE error error MEDIUMTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
