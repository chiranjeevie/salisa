 ...
 */
final class Version20190102154824 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP orderdate');
        $this->addSql('ALTER TABLE revel_to_netsuite_history CHANGE error error MEDIUMTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE customers CHANGE lastorderdate lastorderdate DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customers CHANGE lastorderdate lastorderdate INT NOT NULL');
        $this->addSql('ALTER TABLE netsuite_to_revel_history CHANGE error error MEDIUMTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE orders ADD orderdate VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
