 ...
 */
final class Version20181229095153 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE net_suite_configuration (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, key1 VARCHAR(255) NOT NULL, key2 VARCHAR(255) NOT NULL, key3 VARCHAR(255) NOT NULL, key4 VARCHAR(255) NOT NULL, api_endpoint VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE revel_configuration (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, api_endpoint VARCHAR(255) NOT NULL, key1 VARCHAR(255) NOT NULL, key2 VARCHAR(255) NOT NULL, key3 VARCHAR(255) NOT NULL, key4 VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sync_history CHANGE source source MEDIUMTEXT NOT NULL, CHANGE trans_record trans_record MEDIUMTEXT NOT NULL, CHANGE error error MEDIUMTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE net_suite_configuration');
        $this->addSql('DROP TABLE revel_configuration');
        ...
        $this->addSql('ALTER TABLE sync_history CHANGE source source MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE trans_record trans_record MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE error error MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
