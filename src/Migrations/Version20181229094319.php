 ...
 */
final class Version20181229094319 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE netsuite_to_revel_history (id INT AUTO_INCREMENT NOT NULL, ran_time DATETIME NOT NULL, status INT NOT NULL, error MEDIUMTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE netsuite_to_revel_history');
