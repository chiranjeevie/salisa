 ...
 */
final class Version20181231160906 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sync_history DROP data_json, DROP sdgsdg, CHANGE source source MEDIUMTEXT NOT NULL, CHANGE error error MEDIUMTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sync_history ADD data_json MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci, ADD sdgsdg LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE source source MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE error error MEDIUMTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
