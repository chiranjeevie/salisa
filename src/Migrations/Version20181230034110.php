 ...
 */
final class Version20181230034110 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sync_history ADD destination VARCHAR(255) NOT NULL, ADD error MEDIUMTEXT DEFAULT NULL, CHANGE source source MEDIUMTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sync_history DROP destination, DROP error, CHANGE source source MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
