 ...
 */
final class Version20181230030739 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduler ADD interval_time INT NOT NULL, ADD last_ran_time DATETIME DEFAULT NULL, DROP last_run, CHANGE status status TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduler ADD last_run DATETIME NOT NULL, DROP interval_time, DROP last_ran_time, CHANGE status status INT NOT NULL');
