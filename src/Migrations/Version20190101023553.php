 ...
 */
final class Version20190101023553 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduler ADD is_success INT DEFAULT NULL, CHANGE description description MEDIUMTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduler DROP is_success, CHANGE description description MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
